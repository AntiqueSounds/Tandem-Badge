...
//  uint16_t incr = display.epd2.hasFastPartialUpdate ? 1 : 3;
  ...
  // show where the update box is
    ...
    do
    {
      ...
      display.setRotation(1);
// show wifi status      
      display.setCursor(XSTATUS-20,YSTATUS);
      display.setFont(&WIFI8pt7b);
      display.print(wifiStatus);
      display.setFont(&TomThumb);
      display.setCursor(XSTATUS-40,YSTATUS);
      getVoltage();
      display.print(String(volts) + "v "); display.setCursor(box_x,YSTATUS);
